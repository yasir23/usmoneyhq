...
TOOLS = {
    ...
    "401k-contribution-calculator": ["401k contribution calculator", "how much should i contribute to 401k"],
    "break-even-calculator": ["break even calculator", "break even point calculator"],
    "calorie-deficit-calculator": ["calorie deficit calculator", "how many calories to lose weight"],
    "carpet-calculator": ["carpet calculator", "how much carpet do i need"],
    "commission-calculator": ["commission calculator", "real estate commission calculator"],
    "construction-cost-calculator": ["construction cost calculator", "home construction cost calculator"],
    "date-calculator": ["date calculator", "days between dates calculator"],
    "debt-snowball-calculator": ["debt snowball calculator", "snowball method calculator"],
    "drywall-calculator": ["drywall calculator", "how much drywall do i need"],
    "escrow-calculator": ["escrow calculator", "mortgage escrow calculator"],
    "fence-calculator": ["fence calculator", "how much fence do i need"],
    "fha-mortgage-calculator": ["fha loan calculator", "fha mortgage calculator"],
    "gravel-calculator": ["gravel calculator", "how much gravel do i need"],
    "heart-rate-calculator": ["heart rate calculator", "target heart rate calculator"],
    "home-remodel-cost-calculator": ["home remodel cost calculator", "kitchen remodel cost calculator"],
    "how-long-will-my-money-last-calculator": ["how long will my money last calculator", "retirement withdrawal calculator"],
    "investment-property-calculator": ["investment property calculator", "rental property calculator"],
    "lease-vs-buy-calculator": ["lease vs buy calculator", "car lease vs buy calculator"],
    "life-insurance-needs-calculator": ["life insurance calculator", "how much life insurance do i need"],
    "loan-comparison-calculator": ["loan comparison calculator", "compare loan offers calculator"],
    "mileage-reimbursement-calculator": ["mileage reimbursement calculator", "irs mileage rate calculator"],
    "mortgage-points-calculator": ["mortgage points calculator", "should i buy mortgage points"],
    "moving-cost-calculator": ["moving cost calculator", "how much will moving cost"],
    "percentage-change-calculator": ["percentage change calculator", "percent increase calculator"],
    "personal-loan-calculator": ["personal loan calculator", "personal loan payment calculator"],
    "price-per-square-foot-calculator": ["price per square foot calculator", "cost per square foot calculator"],
    "retirement-age-calculator": ["retirement age calculator", "what age can i retire"],
    "rmd-calculator": ["rmd calculator", "required minimum distribution calculator"],
    "savings-bonds-calculator": ["savings bond calculator", "series i bond calculator"],
    "savings-rate-calculator": ["savings rate calculator", "personal savings rate calculator"],
    "self-employment-tax-calculator": ["self employment tax calculator", "self employed tax calculator"],
    "social-security-calculator": ["social security calculator", "social security benefits calculator"],
    "sod-calculator": ["sod calculator", "how much sod do i need"],
    "stock-profit-calculator": ["stock profit calculator", "stock gain calculator"],
    "take-home-pay-calculator": ["take home pay calculator", "salary take home calculator"],
    "tax-refund-calculator": ["tax refund calculator", "income tax refund calculator"],
    "tile-calculator": ["tile calculator", "how much tile do i need"],
    "time-duration-calculator": ["time duration calculator", "hours calculator"],
    "topsoil-calculator": ["topsoil calculator", "how much topsoil do i need"],
    "va-mortgage-calculator": ["va loan calculator", "va mortgage calculator"],
    "wallpaper-calculator": ["wallpaper calculator", "how much wallpaper do i need"],
}
