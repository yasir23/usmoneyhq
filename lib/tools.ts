...
export const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How accurate is a TDEE calculator?", a: "Mifflin-St Jeor TDEE estimates are typically within about 10-15% of your true value for most people. The biggest error source is the activity multiplier — 'moderately active' can mean very different things to different people. Track your weight for 2-3 weeks against a fixed intake to calibrate, then adjust by 100-200 calories at a time." },
      { q: "How much protein should I eat?", a: "For muscle building or fat loss, most sports nutrition guidance lands at 0.7-1.0 grams of protein per pound of body weight (1.6-2.2 g per kg). A 180 lb person targeting muscle should aim for roughly 130-180 g of protein per day, spread across 3-4 meals." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Does creatine mean I need more water?", a: "Yes. Creatine monohydrate pulls water into your muscle cells, so most sports-nutrition guidance recommends adding roughly 16-24 oz (0.5-0.7 L) of extra water per day while supplementing. A 180 lb lifter on creatine should aim near 120 oz daily instead of the standard ~100 oz." },
      { q: "How much water should I drink to lose weight?", a: "Drinking water before meals is linked to modestly lower calorie intake, but hydration alone doesn't cause fat loss. Hit your weight-based target from this calculator first — a 180 lb person needs ~100+ oz with 30 minutes of exercise — and treat water as a support habit, not the diet itself." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "How much sleep do I need by age?", a: "Adults 18-64 need 7-9 hours per night; adults 65+ do well on 7-8. Teens (13-18) need 8-10 hours, school-age kids (6-12) need 9-12, and toddlers need 11-14. If you consistently wake tired on 7 hours, aim for a full extra cycle — this calculator's 5-cycle option is the adult minimum, 6 cycles is the safer target." },
      { q: "How do I calculate how much sleep I got?", a: "Work backward from your wake time using 90-minute cycles. Waking at 6:00 AM after a 10:30 PM bedtime means roughly 7.5 hours (5 cycles). This calculator returns the exact bedtimes for 6, 5, and 4 cycles so you can match your actual sleep window." },
    ],
