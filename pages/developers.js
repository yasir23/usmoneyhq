  ...
  return (
    <>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              about: "MCP server, llms.txt, and REST API for 105 US finance calculators",
            }),
          }}
        />
      </Head>
      ...
      <main className="container">
        ...
        <h1>Developers: give AI agents 105 finance calculators</h1>
        <p className="lead">
        ...
        <div className="card">
          ...
          <p>
            ...
            <code>{SITE_URL}/api/mcp</code> — all 105 calculators appear as native tools.
          </p>
          <pre>{`"mcpServers": {
  "usmoneyhq": {
